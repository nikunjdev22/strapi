"use strict";(self.webpackChunk_strapi_admin=self.webpackChunk_strapi_admin||[]).push([[8056],{23923:(Oe,A,s)=>{s.r(A),s.d(A,{default:()=>De});var a=s(32735),o=s(88425),L=s(83983),T=s(5636),k=s(84968),w=s(5141),Z=s(77997),z=s.n(Z),O=s(11856),G=s(16540),Y=s(44526),J=s(59290),S=s.n(J),M=s(17247);const K=[{name:"name",key:"name",metadatas:{label:{id:"Settings.apiTokens.ListView.headers.name",defaultMessage:"Name"},sortable:!0}},{name:"description",key:"description",metadatas:{label:{id:"Settings.apiTokens.ListView.headers.description",defaultMessage:"Description"},sortable:!1}},{name:"type",key:"type",metadatas:{label:{id:"Settings.apiTokens.ListView.headers.type",defaultMessage:"Token type"},sortable:!1}},{name:"createdAt",key:"createdAt",metadatas:{label:{id:"Settings.apiTokens.ListView.headers.createdAt",defaultMessage:"Created at"},sortable:!1}}];var X=s(60216),c=s.n(X),h=s(95602),f=s(53214),q=s(19192),_=s(76470),ee=s.n(_),te=s(20763),ne=s(9808),ae=Object.defineProperty,I=Object.getOwnPropertySymbols,se=Object.prototype.hasOwnProperty,oe=Object.prototype.propertyIsEnumerable,V=(n,e,t)=>e in n?ae(n,e,{enumerable:!0,configurable:!0,writable:!0,value:t}):n[e]=t,re=(n,e)=>{for(var t in e||(e={}))se.call(e,t)&&V(n,t,e[t]);if(I)for(var t of I(e))oe.call(e,t)&&V(n,t,e[t]);return n};const B=({tokenName:n,onClickDelete:e})=>{const{formatMessage:t}=(0,T.useIntl)(),{trackUsage:d}=(0,o.useTracking)();return a.createElement(ne.Box,re({paddingLeft:1},o.stopPropagation),a.createElement(te.IconButton,{onClick:()=>{d("willDeleteToken"),e()},label:t({id:"global.delete-target",defaultMessage:"Delete {target}"},{target:`${n}`}),noBorder:!0,icon:a.createElement(ee(),null)}))};B.propTypes={tokenName:c().string.isRequired,onClickDelete:c().func.isRequired};const le=B;var ie=s(95717),ce=s.n(ie),de=s(19615);const ue=(0,de.default)(o.Link)`
  svg {
    path {
