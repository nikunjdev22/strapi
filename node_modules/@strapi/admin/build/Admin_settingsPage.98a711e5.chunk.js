...
`;var kt=function(){return window&&window.strapi&&window.strapi.isEE?a(68464).Z:a(35123).Z}(),Rt=function o(t,n){return`
  `.concat(Ut,` {
...
`,Q=({onClose:B,isOpen:K})=>{(0,C.useLockScroll)(K);const{formatMessage:H}=(0,ze.useIntl)();return K?e.createElement(J.Portal,null,e.createElement(N,{onClick:B},e.createElement(ae.FocusTrap,{onEscape:B},e.createElement(_,{onClick:f=>f.stopPropagation(),"aria-labelledby":"upgrade-plan",background:"neutral0",hasRadius:!0},e.createElement("img",{src:R,alt:"air-balloon"}),e.createElement(W,null,e.createElement(it.IconButton,{onClick:B,"aria-label":"Close",icon:e.createElement(Je(),null)})),e.createElement(pe,{spacing:6},e.createElement(te.Typography,{fontWeight:"bold",textColor:"primary600"},H({id:"app.components.UpgradePlanModal.text-ce",defaultMessage:"COMMUNITY EDITION"})),e.createElement(Se.Stack,{spacing:2},e.createElement(te.Typography,{variant:"alpha",as:"h2",id:"upgrade-plan"},H({id:"app.components.UpgradePlanModal.limit-reached",defaultMessage:"You have reached the limit"})),e.createElement(te.Typography,null,H({id:"app.components.UpgradePlanModal.text-power",defaultMessage:"Unlock the full power of Strapi by upgrading your plan to the Enterprise Edition"}))),e.createElement(Ie.LinkButton,{href:"https://strapi.io/pricing-self-hosted",isExternal:!0,endIcon:e.createElement(Qe(),null)},H({id:"app.components.UpgradePlanModal.button",defaultMessage:"Learn more"}))),e.createElement("img",{src:U,alt:"upgrade-arrow"}))))):null};Q.propTypes={onClose:Ke().func.isRequired,isOpen:Ke().bool.isRequired};const oe=Q;var G=a(73869);const le=()=>{const{roles:B,isLoading:K}=(0,G.bF)(),H=(0,C.useQuery)(),f=decodeURIComponent(H.get("_q")||""),Fe=(0,ne.ZP)(B,f,{keys:["name","description"]});return{isLoading:K,sortedRoles:Fe}},xe=()=>{const{formatMessage:B}=(0,ze.useIntl)(),[K,H]=(0,e.useState)(!1),{trackUsage:f}=(0,C.useTracking)(),{push:Fe}=(0,be.useHistory)(),_e=(0,e.useCallback)(Pe=>{Fe(`/settings/roles/${Pe}`)},[Fe]),He=(0,e.useCallback)(()=>{H(Pe=>!Pe)},[]),q=(0,e.useCallback)(()=>{f("didShowRBACUpgradeModal"),H(!0)},[f]),he=(0,e.useCallback)(Pe=>[{onClick:He,label:B({id:"app.utils.duplicate",defaultMessage:"Duplicate"}),icon:e.createElement(P(),null)},{onClick:()=>_e(Pe.id),label:B({id:"app.utils.edit",defaultMessage:"Edit"}),icon:e.createElement(Y(),null)},{onClick:He,label:B({id:"global.delete",defaultMessage:"Delete"}),icon:e.createElement(fe(),null)}],[B,He,_e]);return{isModalOpen:K,handleToggleModalForCreatingRole:q,handleToggle:He,getIcons:he}},Ve=()=>{const{formatMessage:B}=(0,ze.useIntl)();(0,C.useFocusWhenNavigate)();const{sortedRoles:K,isLoading:H}=le(),{isModalOpen:f,handleToggle:Fe,handleToggleModalForCreatingRole:_e,getIcons:He}=xe(),q=K.length+1,he=5;return e.createElement(Ge.Main,null,e.createElement(C.SettingsPageTitle,{name:"Roles"}),e.createElement(de.HeaderLayout,{primaryAction:e.createElement(Z.Button,{onClick:_e,startIcon:e.createElement(Le(),null),size:"S"},B({id:"Settings.roles.list.button.add",defaultMessage:"Add new role"})),title:B({id:"global.roles",defaultMessage:"roles"}),subtitle:B({id:"Settings.roles.list.description",defaultMessage:"List of roles"})}),e.createElement(de.ContentLayout,null,e.createElement(k.Table,{colCount:he,rowCount:q,footer:e.createElement(k.TFooter,{onClick:_e,icon:e.createElement(Le(),null)},B({id:"Settings.roles.list.button.add",defaultMessage:"Add new role"}))},e.createElement(k.Thead,null,e.createElement(k.Tr,null,e.createElement(k.Th,null,e.createElement(te.Typography,{variant:"sigma",textColor:"neutral600"},B({id:"global.name",defaultMessage:"Name"}))),e.createElement(k.Th,null,e.createElement(te.Typography,{variant:"sigma",textColor:"neutral600"},B({id:"global.description",defaultMessage:"Description"}))),e.createElement(k.Th,null,e.createElement(te.Typography,{variant:"sigma",textColor:"neutral600"},B({id:"global.users",defaultMessage:"Users"}))),e.createElement(k.Th,null,e.createElement($e.VisuallyHidden,null,B({id:"global.actions",defaultMessage:"Actions"}))))),e.createElement(k.Tbody,null,K==null?void 0:K.map(Pe=>e.createElement(z.Z,{key:Pe.id,id:Pe.id,name:Pe.name,description:Pe.description,usersCount:Pe.usersCount,icons:He(Pe)})))),!q&&!H&&e.createElement(y.Z,null)),e.createElement(oe,{isOpen:f,onClose:Fe}))},qe=()=>e.createElement(C.CheckPagePermissions,{permissions:r.Z.settings.roles.main},e.createElement(Ve,null))},75936:(ge,D,a)=>{a.d(D,{Z:()=>C});const C=[]},20178:(ge,D,a)=>{a.d(D,{Z:()=>Qe});var e=a(32735),C=a(64213),r=a(88425),ne=a(9808),V=a(44526),Le=a(11856),Ee=a(78330),fe=a(16540),Ne=a(19192),Y=a(90662),F=a(95602),P=a(37178),Z=a(90353),de=a(98599),k=a.n(de),te=a(83281),Ge=a(33795),$e=a.n(Ge),ze=a(86834),be=a.n(ze),z=a(5636),y=a(5141),ue=a(19615),Ke=a(25793),re=a(73869),J=a(83983),ae=a(5173);const Ie=ae.Ry().shape({name:ae.Z_().required(r.translatedErrors.required),description:ae.Z_().required(r.translatedErrors.required)});var Xe=a(98399),Ye=(ie,Je,R)=>new Promise((U,N)=>{var _=Q=>{try{W(R.next(Q))}catch(oe){N(oe)}},pe=Q=>{try{W(R.throw(Q))}catch(oe){N(oe)}},W=Q=>Q.done?U(Q.value):Promise.resolve(Q.value).then(_,pe);W((R=R.apply(ie,Je)).next())});const Se=ue.default.div`
  ...
  font-size: ${12/16}rem;
  font-weight: bold;
`,ke=()=>{const ie=(0,r.useNotification)(),{lockApp:Je,unlockApp:R}=(0,r.useOverlayBlocker)(),{formatMessage:U}=(0,z.useIntl)(),[N,_]=(0,e.useState)(!1),{replace:pe}=(0,y.useHistory)(),W=(0,e.useRef)(),{trackUsage:Q}=(0,r.useTracking)(),oe=(0,y.useRouteMatch)("/settings/roles/duplicate/:id"),G=$e()(oe,"params.id",null),{isLoading:le,data:xe}=(0,re.U_)(),{permissions:Ue,isLoading:Ve}=(0,re.Dq)(G),st=B=>{Je(),_(!0),Q(G?"willDuplicateRole":"willCreateNewRole"),Promise.resolve((0,r.request)("/admin/roles",{method:"POST",body:B})).then(K=>Ye(void 0,null,function*(){const{permissionsToSend:H}=W.current.getPermissions();return Q(G?"didDuplicateRole":"didCreateNewRole"),K.data.id&&!be()(H)&&(yield(0,r.request)(`/admin/roles/${K.data.id}/permissions`,{method:"PUT",body:{permissions:H}})),K})).then(K=>{_(!1),ie({type:"success",message:{id:"Settings.roles.created",defaultMessage:"created"}}),pe(`/settings/roles/${K.data.id}`)}).catch(K=>{Xe.error(K),_(!1),ie({type:"warning",message:{id:"notification.error"}})}).finally(()=>{R()})},qe=`${U({id:"Settings.roles.form.created",defaultMessage:"Created"})} ${(0,C.format)(new Date,"PPP")}`;return e.createElement(fe.Main,null,e.createElement(r.SettingsPageTitle,{name:"Roles"}),e.createElement(te.Formik,{initialValues:{name:"",description:qe},onSubmit:st,validationSchema:Ie,validateOnChange:!1},({handleSubmit:B,values:K,errors:H,handleReset:f,handleChange:Fe})=>e.createElement(r.Form,{noValidate:!0},e.createElement(e.Fragment,null,e.createElement(Le.HeaderLayout,{primaryAction:e.createElement(Y.Stack,{horizontal:!0,spacing:2},e.createElement(V.Button,{variant:"secondary",onClick:()=>{f(),W.current.resetForm()},size:"L"},U({id:"app.components.Button.reset",defaultMessage:"Reset"})),e.createElement(V.Button,{onClick:B,loading:N,size:"L"},U({id:"global.save",defaultMessage:"Save"}))),title:U({id:"Settings.roles.create.title",defaultMessage:"Create a role"}),subtitle:U({id:"Settings.roles.create.description",defaultMessage:"Define the rights given to the role"}),navigationAction:e.createElement(r.Link,{startIcon:e.createElement(k(),null),to:"/settings/roles"},U({id:"global.back",defaultMessage:"Back"}))}),e.createElement(Le.ContentLayout,null,e.createElement(Y.Stack,{spacing:6},e.createElement(ne.Box,{background:"neutral0",padding:6,shadow:"filterShadow",hasRadius:!0},e.createElement(Y.Stack,{spacing:4},e.createElement(Ne.Flex,{justifyContent:"space-between"},e.createElement(ne.Box,null,e.createElement(ne.Box,null,e.createElement(F.Typography,{fontWeight:"bold"},U({id:"global.details",defaultMessage:"Details"}))),e.createElement(ne.Box,null,e.createElement(F.Typography,{variant:"pi",textColor:"neutral600"},U({id:"Settings.roles.form.description",defaultMessage:"Name and description of the role"})))),e.createElement(Se,null,U({id:"Settings.roles.form.button.users-with-role",defaultMessage:"{number, plural, =0 {# users} one {# user} other {# users}} with this role"},{number:0}))),e.createElement(Ee.Grid,{gap:4},e.createElement(Ee.GridItem,{col:6},e.createElement(P.TextInput,{name:"name",error:H.name&&U({id:H.name}),label:U({id:"global.name",defaultMessage:"Name"}),onChange:Fe,value:K.name})),e.createElement(Ee.GridItem,{col:6},e.createElement(Z.Textarea,{label:U({id:"global.description",defaultMessage:"Description"}),name:"description",error:H.description&&U({id:H.description}),onChange:Fe},K.description))))),!le&&!Ve?e.createElement(ne.Box,{shadow:"filterShadow",hasRadius:!0},e.createElement(Ke.Z,{isFormDisabled:!1,ref:W,permissions:Ue,layout:xe})):e.createElement(ne.Box,{background:"neutral0",padding:6,shadow:"filterShadow",hasRadius:!0},e.createElement(r.LoadingIndicatorPage,null))))))))};function Qe(){return e.createElement(r.CheckPagePermissions,{permissions:J.Z.settings.roles.create},e.createElement(ke,null))}},56899:(ge,D,a)=>{a.d(D,{Z:()=>C});const C=!1},68464:(ge,D,a)=>{a.d(D,{Z:()=>C});const C=!1},32741:(ge,D,a)=>{a.d(D,{Z:()=>C});const C=!1},19665:(ge,D,a)=>{a.d(D,{Z:()=>C});const C=!1},36950:(ge,D,a)=>{a.d(D,{Z:()=>C});const C=!1},96556:(ge,D,a)=>{a.d(D,{Z:()=>C});const C=!1},51899:(ge,D,a)=>{a.d(D,{Z:()=>Je});var e=a(32735),C=a(88425),r=a(83983),ne=a(59290),V=a.n(ne),Le=a(76470),Ee=a.n(Le),fe=a(68192),Ne=a.n(fe),Y=a(95717),F=a.n(Y),P=a(44526),Z=a(11856),de=a(28004),k=a(16540),te=a(53214),Ge=a(95602),$e=a(92891),ze=a(58469),be=a(5636),z=a(5141),y=a(17247),ue=a(73869),Ke=a(78522),re=a(80779),J=a(49415);const ae={roleToDelete:null,showModalConfirmButtonLoading:!1,shouldRefetchData:!1},Ie=(R,U)=>(0,J.default)(R,N=>{switch(U.type){case"ON_REMOVE_ROLES":{N.showModalConfirmButtonLoading=!0;break}case"ON_REMOVE_ROLES_SUCCEEDED":{N.shouldRefetchData=!0,N.roleToDelete=null;break}case"RESET_DATA_TO_DELETE":{N.shouldRefetchData=!1,N.roleToDelete=null,N.showModalConfirmButtonLoading=!1;break}case"SET_ROLE_TO_DELETE":{N.roleToDelete=U.id;break}default:return N}});var Xe=(R,U,N)=>new Promise((_,pe)=>{var W=G=>{try{oe(N.next(G))}catch(le){pe(le)}},Q=G=>{try{oe(N.throw(G))}catch(le){pe(le)}},oe=G=>G.done?_(G.value):Promise.resolve(G.value).then(W,Q);oe((N=N.apply(R,U)).next())});const Ye=()=>{(0,C.useFocusWhenNavigate)();const{isLoading:R,allowedActions:{canCreate:U,canDelete:N,canRead:_,canUpdate:pe}}=(0,C.useRBAC)(r.Z.settings.roles),{getData:W,roles:Q,isLoading:oe}=(0,ue.bF)(!1),[{query:G}]=(0,C.useQueryParams)(),le=(G==null?void 0:G._q)||"",xe=(0,ze.ZP)(Q,le,{keys:["name","description"]});return(0,e.useEffect)(()=>{!R&&_&&W()},[R,_,W]),{isLoadingForPermissions:R,canCreate:U,canDelete:N,canRead:_,canUpdate:pe,isLoading:oe,getData:W,sortedRoles:xe,roles:Q}},Se=({getData:R,canCreate:U,canDelete:N,canUpdate:_})=>{const{formatMessage:pe}=(0,be.useIntl)(),W=(0,C.useNotification)(),[Q,oe]=(0,e.useState)(!1),{push:G}=(0,z.useHistory)(),[{selectedRoles:le,showModalConfirmButtonLoading:xe,roleToDelete:Ue},Ve]=(0,e.useReducer)(Ie,ae),st=()=>Xe(void 0,null,function*(){try{Ve({type:"ON_REMOVE_ROLES"}),yield y.be.post("/admin/roles/batch-delete",{ids:[Ue]}),yield R(),Ve({type:"RESET_DATA_TO_DELETE"})}catch(q){const he=(0,$e.get)(q,["response","payload","data","ids"],null);if(he&&Array.isArray(he)){const Pe=he.join(`
`);W({type:"warning",message:Pe})}else W({type:"warning",message:{id:"notification.error"}})}H()}),qe=(0,e.useCallback)(q=>{G(`/settings/roles/duplicate/${q}`)},[G]),B=()=>G("/settings/roles/new"),K=(0,e.useCallback)(q=>{Ve({type:"SET_ROLE_TO_DELETE",id:q}),H()},[]),H=()=>oe(q=>!q),f=(0,e.useCallback)(q=>{G(`/settings/roles/${q}`)},[G]),Fe=(0,e.useCallback)((q,he)=>{q.preventDefault(),q.stopPropagation(),he.usersCount?W({type:"info",message:{id:"Roles.ListPage.notification.delete-not-allowed"}}):K(he.id)},[W,K]),_e=(0,e.useCallback)((q,he)=>{q.preventDefault(),q.stopPropagation(),qe(he.id)},[qe]),He=(0,e.useCallback)(q=>[...U?[{onClick:he=>_e(he,q),label:pe({id:"app.utils.duplicate",defaultMessage:"Duplicate"}),icon:e.createElement(Ne(),null)}]:[],..._?[{onClick:()=>f(q.id),label:pe({id:"app.utils.edit",defaultMessage:"Edit"}),icon:e.createElement(F(),null)}]:[],...N?[{onClick:he=>Fe(he,q),label:pe({id:"global.delete",defaultMessage:"Delete"}),icon:e.createElement(Ee(),null)}]:[]],[pe,Fe,_e,f,U,_,N]);return{handleNewRoleClick:B,getIcons:He,selectedRoles:le,isWarningDeleteAllOpened:Q,showModalConfirmButtonLoading:xe,handleToggleModal:H,handleDeleteData:st}},Qe=()=>{const{formatMessage:R}=(0,be.useIntl)(),{isLoadingForPermissions:U,canCreate:N,canRead:_,canDelete:pe,canUpdate:W,isLoading:Q,getData:oe,sortedRoles:G}=Ye(),{handleNewRoleClick:le,getIcons:xe,isWarningDeleteAllOpened:Ue,showModalConfirmButtonLoading:Ve,handleToggleModal:st,handleDeleteData:qe}=Se({getData:oe,canCreate:N,canDelete:pe,canUpdate:W}),B=G.length+1,K=6;if(U)return e.createElement(k.Main,null,e.createElement(C.LoadingIndicatorPage,null));const H=R({id:"global.roles",defaultMessage:"roles"});return e.createElement(k.Main,null,e.createElement(C.SettingsPageTitle,{name:"Roles"}),e.createElement(Z.HeaderLayout,{primaryAction:N?e.createElement(P.Button,{onClick:le,startIcon:e.createElement(V(),null),size:"S"},R({id:"Settings.roles.list.button.add",defaultMessage:"Add new role"})):null,title:H,subtitle:R({id:"Settings.roles.list.description",defaultMessage:"List of roles"}),as:"h2"}),_&&e.createElement(Z.ActionLayout,{startActions:e.createElement(C.SearchURLQuery,{label:R({id:"app.component.search.label",defaultMessage:"Search for {target}"},{target:H})})}),_&&e.createElement(Z.ContentLayout,null,e.createElement(te.Table,{colCount:K,rowCount:B,footer:N?e.createElement(te.TFooter,{onClick:le,icon:e.createElement(V(),null)},R({id:"Settings.roles.list.button.add",defaultMessage:"Add new role"})):null},e.createElement(te.Thead,null,e.createElement(te.Tr,null,e.createElement(te.Th,null,e.createElement(Ge.Typography,{variant:"sigma",textColor:"neutral600"},R({id:"global.name",defaultMessage:"Name"}))),e.createElement(te.Th,null,e.createElement(Ge.Typography,{variant:"sigma",textColor:"neutral600"},R({id:"global.description",defaultMessage:"Description"}))),e.createElement(te.Th,null,e.createElement(Ge.Typography,{variant:"sigma",textColor:"neutral600"},R({id:"global.users",defaultMessage:"Users"}))),e.createElement(te.Th,null,e.createElement(de.VisuallyHidden,null,R({id:"global.actions",defaultMessage:"Actions"}))))),e.createElement(te.Tbody,null,G==null?void 0:G.map(f=>e.createElement(re.Z,{key:f.id,id:f.id,name:f.name,description:f.description,usersCount:f.usersCount,icons:xe(f)})))),!B&&!Q&&e.createElement(Ke.Z,null)),e.createElement(C.ConfirmDialog,{isOpen:Ue,onConfirm:qe,isConfirmButtonLoading:Ve,onToggleDialog:st}))},Je=()=>e.createElement(C.CheckPagePermissions,{permissions:r.Z.settings.roles.main},e.createElement(Qe,null))},63775:(ge,D,a)=>{a.d(D,{Z:()=>ne});var e=(V,Le,Ee)=>new Promise((fe,Ne)=>{var Y=Z=>{try{P(Ee.next(Z))}catch(de){Ne(de)}},F=Z=>{try{P(Ee.throw(Z))}catch(de){Ne(de)}},P=Z=>Z.done?fe(Z.value):Promise.resolve(Z.value).then(Y,F);P((Ee=Ee.apply(V,Le)).next())});const ne=[...strapi.features.isEnabled(strapi.features.SSO)?[{Component(){return e(this,null,function*(){return yield a.e(302).then(a.bind(a,49851))})},to:"/settings/single-sign-on",exact:!0}]:[]]}}]);
